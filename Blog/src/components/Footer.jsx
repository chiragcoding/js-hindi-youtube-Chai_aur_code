    ...
    return (
        <div className='bg-gray-900 mt-5 '>
            <div className='px-4 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 '>
                <div className='grid mb-8 grid-cols-6'>
                    <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                        <div>
                            ...
                            <ul className='mt-2 space-y-2'>
                                ...
                                <li>
                                    <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Prefrences</a>
                                </li>
           ...
           */}
                        ...
                        <div>
                            ...
                            <ul className='mt-2 space-y-2'>
                                <li>
                                    <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Infoprenur</a>
                                </li>
                                <li>
                                    <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Personoi</a>
                                </li>
                                <li>
                    ...
                    <div className='md:max-w-md lg:col-span-2 lg:mt-0 mt-5'>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            <input type="email" name="email" id="email" className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:b-0 focus:border-purple-400 focus:outline-none' />
                        ...
                        <p className='mt-4 text-sm text-gray-500'>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Deserunt adipisci eum, illo impedit libero blanditiis. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis, esse?
                        </p>
                ...
                <div className='flex flex-col justify-between pt-5 pb-10 border-t border-gray-800 sm:flex-row sm:mt-0'>
